...
let filterTimeout;
let filteredData = [];
let GLOBAL_JSON_DATA = null; // Constante global para almacenar el JSON cargado
...
async function loadData(filename = 'itinerari_LA51_2_0_1_asc_desc.json') {
    try {
        ...
        data = jsonData;
        GLOBAL_JSON_DATA = jsonData || []; // Asegurar que GLOBAL_JSON_DATA no sea null o undefined
